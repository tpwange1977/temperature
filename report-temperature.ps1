...
-ContentType "multipart/form-data; boundary=----WebKitFormBoundaryHOoY8DQfpu4PkKYF" `
-Body ([System.Text.Encoding]::UTF8.GetBytes("------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486014833`"$([char]13)$([char]10)$([char]13)$([char]10)3209788694$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486014830`"$([char]13)$([char]10)$([char]13)$([char]10)039796$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486014835`"$([char]13)$([char]10)$([char]13)$([char]10)3209788699$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486014831`"$([char]13)$([char]10)$([char]13)$([char]10)36.3$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486015076`"$([char]13)$([char]10)$([char]13)$([char]10)3209796414$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"486014832`"$([char]13)$([char]10)$([char]13)$([char]10)3209788684$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"survey_data`"$([char]13)$([char]10)$([char]13)$([char]10)4FoTYerhlqpl9PSGmuD5IZA5XxlcamtKw7KyOStCqmh48Xr74FqeYIrAPKW8z1zzkIa5iPtnX2DH1TK59oTt0TZzQL2XcM9lhiM9bKMG7C2OKZ2eApsBsrgDTOE1Jzyp1m0IuNbKwk9Qkwg0DwuYDTiNTzE_2B24qvkqCu0quI9o8_2B_2FobV9Z4ipUqaZCzFs1hrI3fQ4O4enl0cdahJ4jhyqldJMBNKPtuCUKQQ1sf_2BtVKXcmbNTjqMc_2Fx9KzLVAD3cPmioZMPrFhqu79Dvs5aK5EP1lHcFfpl4N_2BZ9lOIz6ukQdcyCxchcTAK7cYjnHtuuSfAFqLWHkWMwPgntfXrMRmGo8JLEMJ4W_2FRLAP91q7jhJoxJmpk6DPtiKUpzMULAHyczVuJU8zc8XeVFLIbH7RY7nKqAXz1mQbujqplwS6oAAv4oQ_2FeBJvAyfnLG2W435Q_2BEXnvpzDuj4yxWBhRYUeJRGFQ0HrWsFRRXZrqJBOk6YsajxvM7ye54_2FJDUqoW0bSR9S9Fht2vJ4oFPULGAtGNWqT0cHStflwl4CW_2FGxLsBj6ZAKCPMi9lQEmK7Ue2Zl$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"response_quality_data`"$([char]13)$([char]10)$([char]13)$([char]10){`"question_info`":{`"qid_486014834`":{`"number`":-1,`"type`":`"presentation_text`",`"option_count`":null,`"has_other`":false,`"other_selected`":null,`"relative_position`":null,`"dimensions`":null,`"input_method`":null,`"is_hybrid`":false},`"qid_486014833`":{`"number`":1,`"type`":`"single_choice_vertical`",`"option_count`":1,`"has_other`":false,`"other_selected`":null,`"relative_position`":[[0,0]],`"dimensions`":[1,1],`"input_method`":null,`"is_hybrid`":false},`"qid_486014830`":{`"number`":2,`"type`":`"open_ended`",`"option_count`":null,`"has_other`":false,`"other_selected`":null,`"relative_position`":null,`"dimensions`":null,`"input_method`":null,`"is_hybrid`":true},`"qid_486014835`":{`"number`":3,`"type`":`"single_choice_vertical`",`"option_count`":3,`"has_other`":false,`"other_selected`":null,`"relative_position`":[[1,0]],`"dimensions`":[3,1],`"input_method`":null,`"is_hybrid`":false},`"qid_486014831`":{`"number`":4,`"type`":`"open_ended`",`"option_count`":null,`"has_other`":false,`"other_selected`":null,`"relative_position`":null,`"dimensions`":null,`"input_method`":null,`"is_hybrid`":true},`"qid_486014836`":{`"number`":-1,`"type`":`"presentation_text`",`"option_count`":null,`"has_other`":false,`"other_selected`":null,`"relative_position`":null,`"dimensions`":null,`"input_method`":null,`"is_hybrid`":false},`"qid_486015076`":{`"number`":5,`"type`":`"single_choice_vertical`",`"option_count`":2,`"has_other`":false,`"other_selected`":null,`"relative_position`":[[1,0]],`"dimensions`":[2,1],`"input_method`":null,`"is_hybrid`":false},`"qid_486014832`":{`"number`":6,`"type`":`"single_choice_vertical`",`"option_count`":1,`"has_other`":false,`"other_selected`":null,`"relative_position`":[[0,0]],`"dimensions`":[1,1],`"input_method`":null,`"is_hybrid`":false}},`"tooltip_open_count`":0,`"opened_tooltip`":false,`"start_time`":1618013428098,`"end_time`":1618013440666,`"time_spent`":12568,`"previous_clicked`":false,`"has_backtracked`":false,`"bi_voice`":{}}$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"is_previous`"$([char]13)$([char]10)$([char]13)$([char]10)false$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF$([char]13)$([char]10)Content-Disposition: form-data; name=`"disable_survey_buttons_on_submit`"$([char]13)$([char]10)$([char]13)$([char]10)$([char]13)$([char]10)------WebKitFormBoundaryHOoY8DQfpu4PkKYF--$([char]13)$([char]10)"))
